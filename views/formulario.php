    ...
    <main>
        <div class="form-content">
            ...
            <form action="../includes/envio.php" method="post" id="formulario" style="display: none;">
                ...
                <label for="customRange2" class="form-label">PRIORIDAD (BAJO-MEDIO-ALTO):</label>
                <input type="range" class="form-range" min="1" max="3" id="prioridad" name="prioridad" required>
